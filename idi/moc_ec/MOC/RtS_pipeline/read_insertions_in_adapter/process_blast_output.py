...
if __name__ == '__main__':
    ...
    fig =go.Figure(go.Sunburst(
        labels=['Total reads<br>{}'.format(total_reads), 'No Adapter seq (only DNA)<br>{}'.format(total_reads-reads_with_adapter), 'Has adapter seq<br>{}'.format(reads_with_adapter), 'Has DNA<br>{}'.format(reads_with_adapter-reads_with_only_adapter), 'No DNA<br>{}'.format(reads_with_only_adapter)],
